...
function Submit({id,price}){
  ...
  return (
    <form className="flex flex-col gap-2">
      <Title order={1} my="20">
	{Intl.NumberFormat('en-GB', { maximumSignificantDigits: 2,currency: 'GBP', style: "currency"}).format(price*qty)}
      </Title>

      <Flex align="center" gap="10">
	<Title className="text-main-green" order={3}>Free Delivery</Title>
	<svg  xmlns="http://www.w3.org/2000/svg"  width="40"  height="40"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-truck"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M17 17m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M5 17h-2v-11a1 1 0 0 1 1 -1h9v12m-4 0h6m4 0h2v-6h-8m0 -5h5l3 5" /></svg>
      ...
      <NumberInput value={qty} onChange={setQty} className="w-20 rounded-md" min={1} max={100} label="Quantity"
		   ...
		   rightSection={
		     <button onClick={(e) =>{e.preventDefault();qty < 100 ? setQty(qty+1) : null}} variant="transparent">
      ...
      <Button className="!rounded-md !w-96 !h-14">Add to cart</Button>
    </form>
  )
}
