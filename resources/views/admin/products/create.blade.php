            ...
            <form action="{{ route('admin.products.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <!-- Instead of file uploading, accept public image URLs -->
                        <div class="mb-6">
                            <label for="images" class="block text-sm font-medium text-gray-700 mb-2">Product Image URLs</label>
                            <textarea name="images" id="images" rows="3" required
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">{{ old('images') }}</textarea>
                            <p class="text-sm text-gray-500 mt-1">Enter one or more public image URLs separated by commas (the first URL will be used as the main product image).</p>
                        </div>
                    </div>
                </div>
